        ...
        try {
            const response = await this.client.responses.create({
                ...
                input: [
                    {
                        role: 'system',
                        content: 'Ты рыночный аналитик. Анализируй только предоставленный снимок рынка. Не обещай прибыль, не выдумывай данные, не делай вид, что знаешь новости или стакан, если этого нет во входе. Отвечай по-русски. Будь консервативен: если сетап спорный, выбирай ожидание. Если твой вывод отличается от сигнала стратегического движка, объясни это в разделе рисков и в поле alignmentWithRules.'
                    },
                    {
                        role: 'user',
